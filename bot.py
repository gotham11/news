    ...
    try:
        ...
        for i, item in enumerate(root.iter("item")):
            ...
            items.append({
                ...
                "title": title,
                "url": link_el.text.strip() if link_el is not None and link_el.text else "https://trends.google.com/trending",
                # earlier items in the feed rank higher; fake a descending score
                "score": max(0, 100 - i * 5),
